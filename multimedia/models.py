...
class VideoUpload(models.Model):
    ...
    type = models.CharField(choices=TYPE_CHOICES, verbose_name="video Type", default="dj_smith", max_length=150)
    ...
    cartegory = models.CharField(choices=CART_CHOICES, max_length=150, default="movies")
    def __str__(self):
        return self.title
